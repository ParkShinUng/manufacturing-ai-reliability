...
LOAD-001..005; produces the reports that replace every TARGET (unmeasured)

Specifications: `docs/06-development/TEST_SPECIFICATIONS.md`.
Suites runnable **now** without application code are in `tests/contract/`.
